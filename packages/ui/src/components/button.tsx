...
export const IconButton = ({ icon: Icon, iconClassName, tooltip, ...props }: IconButtonProps) => {
  const autoLabel = typeof tooltip === 'string' ? tooltip : undefined;
  return (
    <Tooltip>
      <TooltipTrigger
        render={(triggerProps) => (
          <Button aria-label={autoLabel} {...triggerProps} {...props}>
